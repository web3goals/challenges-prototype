export const challengeContractAbi = [
  ...
  {
    inputs: [],
    name: "SendingPrizeToCreatorFailed",
    type: "error",
  },
  {
    inputs: [],
    name: "SendingPrizeToWinnerFailed",
    type: "error",
  },
  {
    inputs: [],
    ...
    inputs: [
      ...
      },
      {
        components: [
          ...
          {
            internalType: "bool",
            name: "isPrizeReceived",
            type: "bool",
          },
        ],
        indexed: false,
        internalType: "struct DataTypes.ChallengeParticipant",
        name: "participant",
        type: "tuple",
      },
    ],
